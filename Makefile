...
common_compiler_flags := -DDBUG_OFF -O3 -DNDEBUG -Qunused-arguments -funique-internal-linkage-names -fuse-ld=lld  -Wno-enum-constexpr-conversion -fno-optimize-sibling-calls
common_linker_flags := -fuse-ld=lld -Wl,-z,keep-text-section-prefix -Wl,--build-id -fno-optimize-sibling-calls
